...
const API_BASE = import.meta.env.VITE_KYC_API_BASE || 
  `${import.meta.env.VITE_SUPABASE_URL || 'http://localhost:54321'}/functions/v1/kyc-agent-a2a`;

const IS_DEMO_MODE = import.meta.env.VITE_KYC_DEMO_MODE === 'true';
const KYC_ENV = import.meta.env.VITE_KYC_ENV || 'development';

if (import.meta.env.DEV) {
  console.debug('[KYC Demo] Environment:', KYC_ENV);
  console.debug('[KYC Demo] API Base:', API_BASE);
  console.debug('[KYC Demo] Demo Mode:', IS_DEMO_MODE);
}
